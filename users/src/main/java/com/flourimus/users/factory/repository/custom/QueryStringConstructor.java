...
public class QueryStringConstructor {
    ...
    /**
     * Builds a query string that selects a customer from the database, based on the
     * values in a {@link OrganisationVitalsResponse}.
     * The query string will include the email of the customer, as well as any other
     * organisation vitals that the response indicates should be included.
     * 
     * @param organisationVitals the organisation vitals to include in the query
     *                           string
     * @return the query string
     */
    public static String customerByEmail(final OrganisationVitalsResponse organisationVitals) {
